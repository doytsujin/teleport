...
7. Article titles should follow a `TITLE NAME | Teleport Docs` format. Total character count should not exceed 70 for the entire title since this can impact SEO.
