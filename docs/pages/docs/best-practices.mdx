...
7. Article titles should follow a `TITLE NAME | Teleport Docs` format. The total character count should not exceed 70 for the entire title since this can impact SEO.
8. Page rank matters less now but content matters more. Make sure to have a good, well-worded, description that uses common keywords around the subject. Also, liberally sprinkle said keywords throughout the article.
...
<Figure
  align="center"
  bordered
  caption="Unsplash example"
>
  ![Unsplash example](https://images.unsplash.com/photo-1620629229895-9eb912b04b66?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=624&q=80)
</Figure>
